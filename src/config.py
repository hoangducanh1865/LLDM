...
class Config:
    ...
    def create_new_parser():
        ...
        return parser
    @staticmethod
    def add_pretrain_dataset_argument(parser):
        ...
        parser.add_argument('--data_store_dir',type=str,default=os.path.join('data','datasets','gutenberg'),
        ...
        parser.add_argument('--hf_model_name',type=str,default=Config.TOKENIZER_MODEL_NAME)
        parser.add_argument('--large_dataset',type=int,default=0,choices=[0,1])
        parser.add_argument('--batch_size',type=int,default=100)
    @staticmethod
    def add_pretraining_argument(parser):
        parser.add_argument('--experiment_name',type=str,default='pretraining_on_dataset_gutenburg')
        parser.add_argument('--working_dir',type=str,default=os.path.join('data','work_dir'))
        parser.add_argument('--hf_model_name',type=str,default=Config.TOKENIZER_MODEL_NAME)
        parser.add_argument('--dataset_dir',type=str,default=os.path.join('data','datasets','gutenberg'))
    ...
    @staticmethod
    def add_sfttrain_dataset_argument(parser):
        parser.add_argument('--test_split_pct',type=float,default=0.005,
                            help='Percentage of data that you want to use for train/test split')
        parser.add_argument('--context_length',type=int,default=1024)
        parser.add_argument('--data_store_dir',type=str,default=os.path.join('data','datasets','gutenberg'),
        ...
        parser.add_argument('--large_dataset',type=int,default=0,choices=[0,1])
    @staticmethod
    def add_sfttraining_argument(parser):
        parser.add_argument('--experiment_name',type=str,default='sfttraining_on_large_dataset')
        parser.add_argument('--working_dir',type=str,default=os.path.join('data','work_dir'))
        parser.add_argument('--pretrained_checkpoint_path',type=str,default=None)
        parser.add_argument('--hf_model_name',type=str,default=Config.TOKENIZER_MODEL_NAME)
        parser.add_argument('--dataset_dir',type=str,default=os.path.join('data','datasets','alpaca'))
        parser.add_argument('--num_workers',type=int,default=8)
        parser.add_argument('--batch_size_per_gpu',type=int,default=16)
        parser.add_argument('--gradient_accumulation_steps',type=int,default=1,
                            help='Splits batch_size_per_gpu by gradient_accumulation_steps')
    ...
    def add_inference_argument(parser):
        ...
        parser.add_argument("--remasking_strategy", type=str, default="random", choices=["random", "low_confidence"])
        parser.add_argument("--hf_model_name", type=str, default="distilbert/distilroberta-base")
        parser.add_argument('--show_mask',type=int,default=0,choices=[0,1])
    @staticmethod
    def add_mode_argument(parser):
        parser.add_argument('--mode',type=str,default='inference',
                            choices=['prepare_pretrain_data', 'prepare_sfttrain_data', 'pretrain', 'sfttrain', 'inference'])