...
def pretrain():
    parser=Config.create_new_parser()
    Config.add_pre_training_argument()
    args=parser.parse_args()
    expereiment_dir=os.path.join(args.working_dir,args.experiment_name)
    accelerator=Accelerator(project_dir=expereiment_dir,
    ...
    trainer=Trainer(args=args,
                    ...
                    scheduler=scheduler,
                    loss_fn=loss_fn,
                    expereiment_dir=expereiment_dir)
    trainer.fit()
